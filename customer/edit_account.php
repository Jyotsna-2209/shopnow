...
<img src="customer_images/<?php echo $image; ?>"
width="50" height="50" />
</td>
<td></td>
</tr>
...
<td><input type="text" name="c_city" value="<?php echo $country;?>"required/></td>
</tr>
<tr>
...
<td><input type="text" name="c_address" value="<?php echo $address;?>"required/></td></tr>
<tr align="center">
...
mysql_select_db("ecommerce");
	move_uploaded_file($c_image_tmp,"customer_images/$c_image");
	 ...
	 customer_email='$c_email',customer_pass='$c_pass',customer_city='$c_city',
