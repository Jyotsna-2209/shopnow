...
<tr>
<td align="right">
<b>Enter New Password Again:</b></td>
<td><input type="password" name="new_pass_again" required/></td>
</tr>
<tr align="center">
<td colspan="8" align="center"><input type="submit" name="change_pass" value="change password">
</tr>
</table>
</form>
<?php
...
if(isset($_POST['change_pass']))
{
	...
	$sel_pass="select * from customers where customer_pass=
	'$current_pass' AND customer_email='$user'";
	...
	{
		$update_pass="update customers
		set customer_pass='$new_pass' where
		customer_email='$user'";
